...
# only model on size are performed because this measure is systematically performed for stranded individuals (contrary to weight) and more reliable in our specific case (body mass values are guess estimations)
...
# only model on size are performed because this measure is systematically performed for stranded individuals (contrary to weight) and more reliable in our specific case
